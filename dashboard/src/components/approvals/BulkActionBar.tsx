...
export function BulkActionBar({
  ...
  return (
    <div className="fixed bottom-0 left-0 z-30 w-full border-t border-border/80 bg-surface-1/95 shadow-lg backdrop-blur">
        ...
        <div className="flex items-center gap-2">
          ...
          {mode === "executing" && (
            <div className="flex items-center gap-3">
              <div className="h-1.5 w-40 overflow-hidden rounded-full bg-surface-2/70">
                <div
