...
export const getAcquireLockMutationKey = () => ["acquireLock"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getAcquireLockMutationKey();
...
export type AcquireLockMutationError =
  UnauthorizedResponse | ConflictResponse | InternalServerErrorResponse;
export type AcquireLockMutationVariables = { data: LockRequest };
...
>(
  ...
  TContext
> => {
  return useMutation(getAcquireLockMutationOptions(options), queryClient);
};
/**
...
export const getReleaseLockMutationKey = () => ["releaseLock"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getReleaseLockMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type ReleaseLockMutationError =
  UnauthorizedResponse | NotFoundResponse | InternalServerErrorResponse;
export type ReleaseLockMutationVariables = { data: LockRequest };
...
>(
  ...
  TContext
> => {
  return useMutation(getReleaseLockMutationOptions(options), queryClient);
};
/**
...
export const getRenewLockMutationKey = () => ["renewLock"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getRenewLockMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type RenewLockMutationError =
  UnauthorizedResponse | NotFoundResponse | InternalServerErrorResponse;
export type RenewLockMutationVariables = { data: LockRequest };
...
>(
  ...
  TContext
> => {
  return useMutation(getRenewLockMutationOptions(options), queryClient);
};
/**
