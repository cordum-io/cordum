...
export const getUpdateOIDCGroupRoleMappingMutationKey = () =>
  ["updateOIDCGroupRoleMapping"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    UpdateOIDCGroupRoleMappingMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof updateOIDCGroupRoleMapping>>,
  ...
  TContext
> => {
  const mutationKey = getUpdateOIDCGroupRoleMappingMutationKey();
...
export type UpdateOIDCGroupRoleMappingMutationError =
  ...
  | InternalServerErrorResponse
  | ServiceUnavailableResponse;
export type UpdateOIDCGroupRoleMappingMutationVariables = {
  data: OIDCGroupRoleMappingUpdateRequest;
};
...
> => {
  return useMutation(
    getUpdateOIDCGroupRoleMappingMutationOptions(options),
    queryClient,
  );
};
/**
...
export const getChangeOwnPasswordMutationKey = () =>
  ["changeOwnPassword"] as const;
...
export type ChangeOwnPasswordMutationError =
  BadRequestResponse | UnauthorizedResponse | InternalServerErrorResponse;
export type ChangeOwnPasswordMutationVariables = {
  data: ChangePasswordRequest;
};
...
export const getPutRoleMutationKey = () => ["putRole"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getPutRoleMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type PutRoleMutationError =
  ...
  | TierLimitResponse
  | ServiceUnavailableResponse;
export type PutRoleMutationVariables = { name: string; data: RoleRequest };
...
>(
  ...
  TContext
> => {
  return useMutation(getPutRoleMutationOptions(options), queryClient);
};
/**
 * @summary Delete a custom RBAC role
 */
export const deleteRole = (name: string, signal?: AbortSignal) => {
