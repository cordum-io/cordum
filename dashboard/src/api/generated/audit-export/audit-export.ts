...
export const getTestAuditExportMutationKey = () => ["testAuditExport"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getTestAuditExportMutationKey();
...
>(
  ...
  TContext
> => {
  return useMutation(getTestAuditExportMutationOptions(options), queryClient);
};
