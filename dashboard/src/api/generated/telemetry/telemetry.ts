...
export const getSetTelemetryConsentMutationKey = () =>
  ["setTelemetryConsent"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    SetTelemetryConsentMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof setTelemetryConsent>>,
  ...
  TContext
> => {
  const mutationKey = getSetTelemetryConsentMutationKey();
...
export type SetTelemetryConsentMutationError =
  ...
  | InternalServerErrorResponse
  | ServiceUnavailableResponse;
export type SetTelemetryConsentMutationVariables = {
  data: SetTelemetryConsentBody;
};
...
> => {
  return useMutation(
    getSetTelemetryConsentMutationOptions(options),
    queryClient,
  );
};
