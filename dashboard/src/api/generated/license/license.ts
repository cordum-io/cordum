...
export const getReloadLicenseMutationKey = () => ["reloadLicense"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getReloadLicenseMutationKey();
...
>(
  ...
  TContext
> => {
  return useMutation(getReloadLicenseMutationOptions(options), queryClient);
};
