...
export const getInstallMarketplacePackMutationKey = () =>
  ["installMarketplacePack"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    InstallMarketplacePackMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof installMarketplacePack>>,
  ...
  TContext
> => {
  const mutationKey = getInstallMarketplacePackMutationKey();
...
export type InstallMarketplacePackMutationError =
  ...
  | InternalServerErrorResponse
  | BadGatewayResponse;
export type InstallMarketplacePackMutationVariables = {
  data: MarketplaceInstallRequest;
};
...
> => {
  return useMutation(
    getInstallMarketplacePackMutationOptions(options),
    queryClient,
  );
};
