...
export type SubmitJobMutationError =
  ...
  | PayloadTooLargeResponse
  | InternalServerErrorResponse;
export type SubmitJobMutationVariables = { data: SubmitJobRequest };
...
>(
  ...
  TContext
> => {
  return useMutation(getSubmitJobMutationOptions(options), queryClient);
};
/**
 * @summary List jobs
 */
...
export type CancelJobMutationError =
  ...
  | ConflictResponse
  | InternalServerErrorResponse;
export type CancelJobMutationVariables = { id: string };
...
export const getRemediateJobMutationKey = () => ["remediateJob"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getRemediateJobMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type RemediateJobMutationError =
  ...
  | NotFoundResponse
  | InternalServerErrorResponse;
export type RemediateJobMutationVariables = {
  id: string;
  data: RemediateJobBody;
};
...
>(
  ...
  TContext
> => {
  return useMutation(getRemediateJobMutationOptions(options), queryClient);
};
/**
