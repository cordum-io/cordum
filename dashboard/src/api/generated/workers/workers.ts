...
export const getRevokeWorkerSessionMutationKey = () =>
  ["revokeWorkerSession"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    RevokeWorkerSessionMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof revokeWorkerSession>>,
  ...
  TContext
> => {
  const mutationKey = getRevokeWorkerSessionMutationKey();
...
export type RevokeWorkerSessionMutationError =
  ...
  | InternalServerErrorResponse
  | ServiceUnavailableResponse;
export type RevokeWorkerSessionMutationVariables = { id: string };
...
> => {
  return useMutation(
    getRevokeWorkerSessionMutationOptions(options),
    queryClient,
  );
};
