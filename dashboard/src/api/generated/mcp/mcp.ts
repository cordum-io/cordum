...
export const getMcpMessageMutationKey = () => ["mcpMessage"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getMcpMessageMutationKey();
...
export type McpMessageMutationError =
  BadRequestResponse | UnauthorizedResponse | ForbiddenResponse | Error;
export type McpMessageMutationVariables = { data: JsonRpcRequest };
...
>(
  ...
  TContext
> => {
  return useMutation(getMcpMessageMutationOptions(options), queryClient);
};
/**
...
export const getPostMcpGatewayUpstreamMutationKey = () =>
  ["postMcpGatewayUpstream"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getPostMcpGatewayUpstreamMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
> => {
  return useMutation(
    getPostMcpGatewayUpstreamMutationOptions(options),
    queryClient,
  );
};
/**
...
export const getPostMcpGatewayClientsConnectMutationKey = () =>
  ["postMcpGatewayClientsConnect"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getPostMcpGatewayClientsConnectMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export const getApproveMcpApprovalMutationKey = () =>
  ["approveMcpApproval"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    ApproveMcpApprovalMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof approveMcpApproval>>,
  ...
  TContext
> => {
  const mutationKey = getApproveMcpApprovalMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type ApproveMcpApprovalMutationResult = NonNullable<
  Awaited<ReturnType<typeof approveMcpApproval>>
>;
export type ApproveMcpApprovalMutationBody =
  ApprovalDecisionRequest | undefined;
export type ApproveMcpApprovalMutationError =
  ...
  | ConflictResponse
  | ServiceUnavailableResponse;
export type ApproveMcpApprovalMutationVariables = {
  id: string;
  data?: ApprovalDecisionRequest;
};
...
> => {
  return useMutation(
    getApproveMcpApprovalMutationOptions(options),
    queryClient,
  );
};
/**
...
export const getRejectMcpApprovalMutationKey = () =>
  ["rejectMcpApproval"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    RejectMcpApprovalMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof rejectMcpApproval>>,
  ...
  TContext
> => {
  const mutationKey = getRejectMcpApprovalMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type RejectMcpApprovalMutationResult = NonNullable<
  Awaited<ReturnType<typeof rejectMcpApproval>>
>;
export type RejectMcpApprovalMutationBody = ApprovalDecisionRequest | undefined;
export type RejectMcpApprovalMutationError =
  ...
  | ConflictResponse
  | ServiceUnavailableResponse;
export type RejectMcpApprovalMutationVariables = {
  id: string;
  data?: ApprovalDecisionRequest;
};
...
>(
  ...
  TContext
> => {
  return useMutation(getRejectMcpApprovalMutationOptions(options), queryClient);
};
/**
...
export const getVerifyMcpSignatureMutationKey = () =>
  ["verifyMcpSignature"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    VerifyMcpSignatureMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof verifyMcpSignature>>,
  ...
  TContext
> => {
  const mutationKey = getVerifyMcpSignatureMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type VerifyMcpSignatureMutationVariables = {
  data: VerifyMcpSignatureBody;
};
...
> => {
  return useMutation(
    getVerifyMcpSignatureMutationOptions(options),
    queryClient,
  );
};
/**
