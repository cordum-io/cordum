...
* **Smoke Test:** Run `CORDUM_API_KEY=${CORDUM_API_KEY:-super-secret-key} ./tools/scripts/platform_smoke.sh`
...
Dashboard: `http://localhost:8082` (API key defaults to `super-secret-key`).
